...
func TestClientBaseURL(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			address: "stealthscale.example.com:50443",
			want:    "https://stealthscale.example.com:50443",
		},
		{
			name:    "explicit https scheme is kept",
			address: "https://stealthscale.example.com",
			want:    "https://stealthscale.example.com",
		},
		{
