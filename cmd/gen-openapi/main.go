// Command gen-openapi emits a StealthScale OpenAPI document from the authoritative
...
var specs = map[string]spec{
	"v1": {apiv1.Spec, apiv1.Spec30, "openapi/v1/stealthscale.yaml"},
	"v2": {apiv2.Spec, apiv2.Spec30, "openapi/v2/stealthscale.yaml"},
}
