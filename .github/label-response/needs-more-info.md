...
- **StealthScale version**: (run `stealthscale version`)
...
Please follow our [Debugging and Troubleshooting Guide](https://stealthscale.net/stable/ref/debug/) and provide:
...
4. **StealthScale server logs** with `log.level: trace` enabled

5. **StealthScale configuration** (with sensitive values redacted - see rules below)
