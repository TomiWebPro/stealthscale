...
StealthScale aims to implement a self-hosted, open source alternative to the Tailscale control server. StealthScale's goal is
to provide self-hosters and hobbyists with an open-source server they can use for their projects and labs. This page
provides on overview of StealthScale's feature and compatibility with the Tailscale control server:
...
- [x] [DNS](../ref/dns.md)
    ...
    - [x] [Extra DNS records (StealthScale only)](../ref/dns.md#setting-extra-dns-records)
- [x] File sharing
...
- [x] [Policy](../ref/policy.md) ([GitHub label "policy"](https://github.com/tomiwebpro/stealthscale/labels/policy%20%F0%9F%93%9D))
    - [x] ACLs
    - [x] Grants
...
- [x] [Node registration using Single-Sign-On (OpenID Connect)](../ref/oidc.md) ([GitHub label "OIDC"](https://github.com/tomiwebpro/stealthscale/labels/OIDC))
    - [x] Basic registration
    - [x] Update user profile from identity provider
    - [ ] OIDC groups cannot be used in ACLs
- [ ] [Funnel](https://tailscale.com/docs/features/tailscale-funnel) ([#1040](https://github.com/tomiwebpro/stealthscale/issues/1040))
- [ ] [Serve](https://tailscale.com/docs/features/tailscale-serve) ([#1234](https://github.com/tomiwebpro/stealthscale/issues/1921))
- [ ] [Network flow logs](https://tailscale.com/docs/features/logging/network-flow-logs) ([#1687](https://github.com/tomiwebpro/stealthscale/issues/1687))
