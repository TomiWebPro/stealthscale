// Package scope models the OAuth capability scopes the StealthScale v2 API enforces
...
// against Tailscale's scopes works unchanged against StealthScale. The grant
