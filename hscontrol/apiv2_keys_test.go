...
func newKeyTestAPI(t *testing.T) (*StealthScale, humatest.TestAPI) {
	t.Helper()
...
func srvKey(t *testing.T, app *StealthScale, id string) types.PreAuthKey {
	t.Helper()
...
func keyCount(t *testing.T, app *StealthScale) int {
	t.Helper()
