// Tests pinned against captures for juanfont/stealthscale#3212.
//
...
// AllowedIPs. StealthScale must do the same — that is the user-visible UX
...
// SaaS captures and asserts stealthscale's BuildPeerMap surfaces every
// exit-route advertiser to every ACL-source node — matching the peer
// list in the captured netmap.
//
// The bug fixed by this PR (#3212) was that stealthscale skipped
