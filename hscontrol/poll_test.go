...
func TestServeLongPollWritesErrorWhenInitialMapFails(t *testing.T) {
	...
	database, err := db.NewStealthScaleDatabase(app.cfg)
...
// no deletion scheduled (https://github.com/tomiwebpro/stealthscale/issues/3382).
...
// https://github.com/tomiwebpro/stealthscale/issues/3129.
//
// Scenario:
