...
type IPAllocator struct {
	...
	// until the next restart of StealthScale.
...
// when stealthscale starts and needs to finish its read
...
// iterate through all of the current nodes ([types.Node]) in stealthscale
