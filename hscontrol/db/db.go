...
import (
	...
	"github.com/tomiwebpro/stealthscale/hscontrol/db/sqliteconfig"
...
// NewStealthScaleDatabase creates a new database connection and runs migrations.
...
func NewStealthScaleDatabase(cfg *types.Config) (*HSDatabase, error) {
...
AND auth_key_id NOT IN (
  ...
  name
			...
			},
			{
				...
				// Fixes: https://github.com/tomiwebpro/stealthscale/issues/3006
			...
			},
			{
				...
				// Fixes: https://github.com/tomiwebpro/stealthscale/issues/3077
