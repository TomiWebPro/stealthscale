...
To authenticate, visit:
        ...
        https://stealthscale.example.com/register/3oYCOZYA2zZmGB4PQ7aHBaMi

Success.`,
			wantURL: "https://stealthscale.example.com/register/3oYCOZYA2zZmGB4PQ7aHBaMi",
			wantErr: "",
		},
		{
			name: "valid http URL",
...
To authenticate, visit:
        ...
        http://stealthscale.example.com/register/3oYCOZYA2zZmGB4PQ7aHBaMi

Success.`,
			wantURL: "http://stealthscale.example.com/register/3oYCOZYA2zZmGB4PQ7aHBaMi",
			wantErr: "",
		},
		{
			name: "no URL",
...
To authenticate, visit:
        ...
        http://stealthscale.example.com/register/dv1l2k5FackOYl-7-V3mSd_E

Success.`,
			wantURL: "",
			wantErr: "multiple URLs found: https://stealthscale.example.com/register/3oYCOZYA2zZmGB4PQ7aHBaMi and http://stealthscale.example.com/register/dv1l2k5FackOYl-7-V3mSd_E",
		},
		{
			name: "invalid URL",
			output: `
...
func TestParseTraceroute(t *testing.T) {
 ...
 1  ts-head-hk0urr.stealthscale.net (100.64.0.1)  1.135 ms  0.922 ms  0.619 ms
 2  172.24.0.3 (172.24.0.3)  0.593 ms  0.549 ms  0.522 ms`,
			want: Traceroute{
				...
				Route: []TraceroutePath{
					{
						Hop:      1,
						Hostname: "ts-head-hk0urr.stealthscale.net",
