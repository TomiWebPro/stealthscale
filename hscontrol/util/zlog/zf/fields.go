...
//
//	import "github.com/tomiwebpro/stealthscale/hscontrol/util/zlog/zf"
//
// Usage:
//
...
const (
	DebugDeadlock              = "STEALTHSCALE_DEBUG_DEADLOCK"
	DebugDERPUseIP             = "STEALTHSCALE_DEBUG_DERP_USE_IP"
	DebugDumpConfig            = "STEALTHSCALE_DEBUG_DUMP_CONFIG"
	DebugHighCardinalityMetric = "STEALTHSCALE_DEBUG_HIGH_CARDINALITY_METRICS"
	DebugProfilingEnabled      = "STEALTHSCALE_DEBUG_PROFILING_ENABLED"
	DebugTailSQLEnabled        = "STEALTHSCALE_DEBUG_TAILSQL_ENABLED"
)
