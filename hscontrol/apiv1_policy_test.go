...
func seedPolicy(policy string) func(t *testing.T, app *StealthScale) {
	return func(t *testing.T, app *StealthScale) {
		t.Helper()
...
func createFilePolicyApp(t *testing.T) *StealthScale {
	t.Helper()
