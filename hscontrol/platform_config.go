...
func (h *StealthScale) WindowsConfigMessage(
...
func (h *StealthScale) AppleConfigMessage(
	writer http.ResponseWriter,
	req *http.Request,
) {
	writer.Header().Set("Content-Type", "text/html; charset=utf-8")
...
func (h *StealthScale) ApplePlatformConfig(
	writer http.ResponseWriter,
	req *http.Request,
) {
...
<plist version="1.0">
  <dict>
    ...
    <string>StealthScale</string>
    <key>PayloadDescription</key>
    <string>Configure Tailscale login server to: {{.URL}}</string>
    <key>PayloadIdentifier</key>
    <string>com.github.tomiwebpro.stealthscale</string>
