// Package apiv1 is the code-first Huma implementation of the StealthScale v1 API.
...
func NewAPI(router chi.Router, backend Backend) huma.API {
	config := huma.DefaultConfig("StealthScale API", "v1")
	config.Info.Description = "StealthScale control server API."
