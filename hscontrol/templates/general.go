...
// that matches the official StealthScale documentation design.
...
// stealthscaleLogo returns the StealthScale SVG logo for consistent branding across all pages.
// The logo is styled by the .stealthscale-logo CSS class.
func stealthscaleLogo() elem.Node {
...
// page renders a standard StealthScale page: the given title in the document
// head, and a body that begins with the StealthScale logo, contains the supplied
...
func page(title string, content ...elem.Node) *elem.Element {
	...
	body = append(body, stealthscaleLogo())
