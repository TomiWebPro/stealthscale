...
// These constants define the visual language for all StealthScale HTML templates.
...
// Typography System
// EXTRACTED FROM: https://stealthscale.net/stable/assets/stylesheets/main.342714a4.min.css
...
func downloadButton(href, text string) *elem.Element {
	return elem.A(attrs.Props{
		attrs.Href:     href,
		attrs.Download: "stealthscale_macos.mobileconfig",
		attrs.Style: styles.Props{
