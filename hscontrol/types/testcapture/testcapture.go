// Package testcapture defines the on-disk format used by StealthScale's
...
// between the capture tool and stealthscale becomes a compile error
...
type Input struct {
	...
	// trips losslessly without parsing — stealthscale's policy parser
	// reads it on demand.
...
// tailscale.com/client/tailscale/v2 — in practice the stealthscale
...
// capture time. StealthScale's compat tests use this to construct
...
type TopologyNode struct {
	...
	// approved. Used by StealthScale's NodeCanApproveRoute test.
