...
// User is the way StealthScale implements the concept of users in Tailscale
//
...
// Email and OIDCIdentifier will be set when the user has stealthscale
// enabled with OIDC, which means that there is a domain involved which
// should be used throughout stealthscale, in information returned to the
