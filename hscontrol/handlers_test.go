...
// The [http.MaxBytesReader] is applied in [StealthScale.VerifyHandler], so we simulate
...
// https://github.com/tomiwebpro/stealthscale/issues/3380. The /key handler
...
func TestKeyHandler_UnsupportedCapVerDoesNotLeakKey(t *testing.T) {
	...
	h := &StealthScale{noisePrivateKey: &noise}
